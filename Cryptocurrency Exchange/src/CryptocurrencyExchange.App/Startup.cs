...
using CryptocurrencyExchange.Business.Services;
using CryptocurrencyExchange.Data.Context;
using CryptocurrencyExchange.Data.Repository;
...
namespace CryptocurrencyExchange.App
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<CryptocurrencyDbContext>();
